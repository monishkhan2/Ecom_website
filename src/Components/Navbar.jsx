            ...
            <div className="container-fluid fixed-top px-0 wow fadeIn bg-primary" data-wow-delay="0.1s">
                <div className="top-bar row gx-0 align-items-center d-none d-lg-flex">
                    <div className="col-lg-6 px-5 text-start">
                        {/* <small><i className="fa fa-map-marker text-primary me-2"></i>C34,Shaheenbagh,Delhi</small>  */}
                    ...
                    <div className="col-lg-6 px-5 text-end">
                        <small><a href="mailto:monishk043@gmail.com" target="/_blank" rel="noreferrer" className='my-text-color'><i className="fa fa-envelope my-text-color me-2"></i>monishk043@gmail.com</a></small>
                        <small className="ms-4"><a href="tel:7521838398" target="/_blank" rel="noreferrer" className='my-text-color'><i className="fa fa-phone my-text-color me-2"></i>+91-7521838398</a></small>
                        <small className="ms-4"><a href="https://wa.me/7521838398" className='my-text-color'><i className="fa fa-whatsapp my-text-color me-2"></i>+91-7521838398</a></small>
                    </div>
                </div>
