    ...
    return (
        <>
                ...
                <div id="header-carousel" className="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            <img className="w-100" src="img/p10.jpg" style={{ height: 800 }} alt="Image" />
                            <div className="carousel-caption">
                                <div className="container">
                                    <div className="row justify-content-start">
                                        <div className="col-lg-8">
                                            <p
                                                className="my-text-color d-inline-block border border-white rounded my-text-color fw-semi-bold py-1 px-3 animated slideInDown">
                                                Welcome to Ecommerce</p>
                                            <h1 className="display-5 mb-4 animated slideInDown " >Best in Industry Products for Male</h1>
                        ...
                        <div className="carousel-item">
                            <img className="w-100" src="img/p6.jpg" style={{ height: 700 }} alt="Image" />
                            <div className="carousel-caption">
                                <div className="container">
                                    <div className="row justify-content-start">
                        ...
                        <div className="carousel-item">
                            <img className="w-100" src="img/p7.jpg" style={{ height: 800 }} alt="Image" />
                            <div className="carousel-caption">
                                <div className="container">
                                    <div className="row justify-content-start">
                                        <div className="col-lg-7">
                                            <p
                                                className="my-text-color d-inline-block border border-white rounded my-text-color fw-semi-bold py-1 px-3 animated slideInDown">
                                                Welcome to Ecommerce</p>
                                            <h1 className="display-5 mb-4 animated slideInDown">Best in Industry Products for kids</h1>
                ...
                <div className="container">
                    <div className="row g-4 align-items-end mb-4">
                        ...
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                            ...
                            <h1 className="display-5 mb-4">We Help Our Customers in Case of Refund, Return and Other</h1>
            ...
            <div className="container-xxl py-2">
                <div className="container">
                    <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "600px" }}>
                        <h3 className=" mb-2">Latest Male Products</h3>
                    </div>
                    <ProjectSlider data={products.filter(x => x.maincategory === "Male")} />
                </div>
            </div>
            <div className="container-xxl py-2">
                <div className="container">
                    <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "600px" }}>
                        <h3 className=" mb-2">Latest Female Products</h3>
                    </div>
                    <ProjectSlider data={products.filter(x => x.maincategory === "Female")} />
                </div>
            </div>
            <div className="container-xxl py-2">
                <div className="container">
                    <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "600px" }}>
                        <h3 className=" mb-2">Latest Kids Products</h3>
                    </div>
                    <ProjectSlider data={products.filter(x => x.maincategory === "kids")} />
                </div>
            </div>
            {/* <!-- Projects End --> */}
            ...
            <div className="container-xxl py-2">
                <div className="container">
                    <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "600px" }}>
                        ...
                        <h3 className=" mb-3">Latests Products</h3>
                    </div>
                    <div className="row g-4">
                        {
            ...
            <div className="container-xxl service py-2">
                <div className="container">
                    <div className="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "600px" }}>
                        <h3 className="mb-4">Awesome E-Commerce Plateform for Cloths</h3>
                    </div>
